...
###  functions.R  ###
This file contains functions to execute [edgeR](https://bioconductor.org/packages/edgeR/), [DESeq2](https://bioconductor.org/packages/DESeq2/), [TCC](https://bioconductor.org/packages/TCC/), and [MBCdeg](https://pubmed.ncbi.nlm.nih.gov/34670485/).
